...
#import "LHTextCodeView.h"
@interface LHTextCodeView ()
...
@property (nonatomic, strong) NSMutableArray<LHTC_lineView *> *lines;

/// 临时保存上次输入的内容(用于判断 删除 还是 输入)
@property (nonatomic, copy) NSString *tempStr;

@end
@implementation LHTextCodeView
...
- (void)configTextField
{
    ...
    for (NSInteger i = 0; i < self.itemCount; i++)
    {
        LHTC_lineView *line = [LHTC_lineView new];
